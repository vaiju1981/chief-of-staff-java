...
Status: **P0 + P1 implemented** — `agent-creator` is wired, routed by the supervisor, and persists notes to
`data/vault/creator/`. P2 (image enrichment end-to-end) and P3 (arxiv/medium/youtube sources) remain.
